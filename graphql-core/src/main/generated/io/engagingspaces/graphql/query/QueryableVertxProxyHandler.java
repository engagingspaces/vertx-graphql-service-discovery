...
public class QueryableVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final Queryable service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public QueryableVertxProxyHandler(Vertx vertx, Queryable service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public QueryableVertxProxyHandler(Vertx vertx, Queryable service, long timeoutInSecond) {
