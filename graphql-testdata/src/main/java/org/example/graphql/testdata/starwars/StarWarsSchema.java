...
public class StarWarsSchema {
    ...
    public static final GraphQLEnumType episodeEnum = newEnum()
            .name("Episode")
    ...
    public static final GraphQLInterfaceType characterInterface = newInterface()
            .name("Character")
    ...
    public static final GraphQLObjectType humanType = newObject()
            .name("Human")
